      ...
      <DialogContent className="max-w-screen-xl h-4/5 rounded-full flex flex-col">
        ...
        {uploadVideo ? (
          <div className="flex justify-end">
            <Button size="lg" onClick={handleDeleteVideoImageURL} disabled={removeloading}>
              {removeloading ? 'Yükleniyor...' : "Video'yu sil"}
            </Button>
            <Button size="lg" onClick={handleAddVideo} disabled={createloading}>
          ...
          <DialogFooter>
            <span className="text-sm">
              Videolarınızı Sayfamıza yükleyerek, Hizmet şartlarını kabul etmiş olursunuz.
              Lütfen başkalarının telif veya gizlilik haklarını ihlal etmediğinizden emin olun.
            </span>
          </DialogFooter>
        )}
      </DialogContent>
